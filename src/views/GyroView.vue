<template>
  <div class="about">
    <div>
      ...
      <Canvas class="canvas-wrapper" :style="{ backgroundColor: `rgba(${backgroundColor(0)},1)` }">
        <component
          :is="ParticleGyro"
          :contentBackgroud="backgroundColor(0)"
          ref="componentRef"
        ></component>
      </Canvas>
      <Permission @click="componentRef.initializeParticles()" />
    </div>
  </div>
</template>
